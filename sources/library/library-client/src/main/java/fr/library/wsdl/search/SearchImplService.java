 ...
 * 
 */
@WebServiceClient(name = "SearchImplService", targetNamespace = "http://entrypoint.webservices.library.fr/", wsdlLocation = "http://51.68.230.132:8080/library-webservice/search?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://51.68.230.132:8080/library-webservice/search?wsdl");
