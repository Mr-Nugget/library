 ...
 * 
 */
@WebServiceClient(name = "SearchImplService", targetNamespace = "http://entrypoint.webservices.library.fr/", wsdlLocation = "http://legion-titouan:8080/library-webservice8110079376350379511/search?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://legion-titouan:8080/library-webservice8110079376350379511/search?wsdl");
